...
function Header() {
  ...
  return (
    ...
    <div className="iconmenu cursor-pointer md:hidden flex duration-400" onClick={toggleIcon}>
      {
        isListIcon ?
    ...
    {isMenuOpen && (
        ...
        <div className="menumaskcontent">
          <header>
            <ul className='header flex justify-between duration-300  items-center px-12 w-full text-white'>
            <li onClick={closeMenu}><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
                <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
              </svg>
              </li>
              <li className='logo text-3xl font-bold'><a href='/'>Fabrice</a></li>
              <a href="/nopage">
                  <li className='flex items-center cursor-pointer'><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
                    <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                  </svg><span>{count}</span></li>
              </a>
            </ul>
          </header> 
            <ul className='body flex flex-col justify-around'>
              <li className='text-4xl md:text-5xl lg:text-6xl'><a href="/buypage">Acheter</a></li>
              <li className='text-4xl md:text-5xl lg:text-6xl'><a href="/history">Notre histoire</a></li>
              <li className='text-4xl md:text-5xl lg:text-6xl'><a href="/journal">Journal</a></li>
              <li className='text-4xl md:text-5xl lg:text-6xl'><a href="/contact">Contact</a></li>
            </ul>
      ...
      {/* <div className="menumask hidden flex-col cursor-pointer h-screen bg-[#38383B] ">
        <div className="menumaskcontent">
          <header>
            <ul className='header flex justify-between duration-300  items-center px-12 w-full text-white'>
            ...
            <ul className='body flex flex-col justify-around'>
              <li className='text-4xl md:text-5xl lg:text-6xl'><a href="/buypage"></a>Acheter</li>
              <li className='text-4xl md:text-5xl lg:text-6xl'><a href="/history"></a>Notre histoire</li>
              <li className='text-4xl md:text-5xl lg:text-6xl'><a href="/journal"></a>Journal</li>
              <li className='text-4xl md:text-5xl lg:text-6xl'><a href="/contact"></a>Contact</li>
            </ul>
          <footer>
            <ul className='flex gap-4'>
                    <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
      ...
      <div className="panier">
        <ul>
          <a href="/nopage">
            <li className='flex items-center cursor-pointer'><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
              <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
            </svg><span className='text-2xl'>{count}</span></li>
          </a>
        </ul>
      </div>
    </div>
